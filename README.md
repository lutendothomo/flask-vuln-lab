...
| 2 | SQL injection (search) | `notes()` | Fixed -- parameterized query |
| 3 | Stored XSS | `templates/notes.html` | Fixed -- auto-escaping restored |
...
**Exploit.** Logging in with the username and any password caused the query to evaluate to `WHERE username = '' OR
